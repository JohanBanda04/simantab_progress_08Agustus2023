...
//echo $tanggala.'<br>'.$tanggalb.'<br>';die;
...
//$query_bk_1 = mysqli_query($koneksi, "SELECT  pengajuan.kode_brg, nama_brg, pengajuan.jumlah,pengajuan.satuan,
...
while($row = mysqli_fetch_array($query)){
    ...
    $sheet->setCellValue('C'.$i,date('d/m/Y', strtotime($row['tgl_pengajuan'])) );
...
$filename = "Laporan_Rekapitulasi_Pengajuan.xlsx";
