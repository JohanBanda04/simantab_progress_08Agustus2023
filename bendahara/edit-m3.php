                      ...
                      <form method="post"  action="edit-proses-m3.php" class="form-horizontal">
                          <div class="box-body">
                              ...
                              <div class="form-group ">
                                  ...
                                  <div class="col-sm-4">
                                      <input type="text" readonly  value="<?= $data2['kode_brg']; ?>" class="form-control" name="kode_brg">
                                  </div>
                              </div>
                              <div class="form-group">
                                      ...
                                      <select id="jenis_brg" required="isikan dulu" class="form-control" name="id_jenis">
                                          ...
                                          if (mysqli_num_rows($queryJenis)) {
                                              ...
                                              while($row=mysqli_fetch_assoc($queryJenis)):
                                                  ...
                                                  ?>
                                                  <option <?php if($data2['id_jenis']==$row['id_jenis']) echo "selected"; ?>  value="<?= $row['id_jenis']; ?>"><?= $row['jenis_brg']; ?></option>
                                              <?php endwhile; } ?>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-4">
                                      <input type="text" class="form-control" value="<?= $data2['nama_brg']; ?>" name="nama_brg">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label id="tes"for="hargabarang" class="col-sm-offset-1 col-sm-3 control-label">Harga Barang</label>
                                  <div class="col-sm-4">
                                      <input type="number" class="form-control" value="<?= $data2['hargabarang']; ?>" name="hargabarang">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Satuan</label>
                                  <div class="col-sm-4">
                                      <input type="text" class="form-control" value="<?= $data2['satuan']; ?>" name="satuan">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Jumlah</label>
                                  <div class="col-sm-4">
                                      <input type="number" class="form-control" value="<?= $data2['stok']; ?>" name="jumlah">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label for="jumlah" class="col-sm-offset-1 col-sm-3 control-label">Keterangan</label>
                                  <div class="col-sm-4">
                                      <input type="text" class="form-control" value="<?= $data2['keterangan']; ?>" name="keterangan">
                                  </div>
                              </div>
                              <div class="form-group">
                                  ...
                                  <a href="index.php?p=material-m3&id_jenis=3&pas=perlengkapanlainnya" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>
                              </div>
                          </div>
                      </form>
                  </div>
